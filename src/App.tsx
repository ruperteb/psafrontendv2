...
import {
  ...
  Landlord,
  PropertyList as SavedPropertyList,
...
function App() {
  const { setToken, setAuthorised } = useContext(AuthContext);
  ...
  if (propertyError?.message === "Not logged in") {
    setToken(undefined);
    setAuthorised(false);
  }
  ...
  if (suburbError?.message === "Not logged in") {
    setToken(undefined);
    setAuthorised(false);
  }
  ...
  if (regionError?.message === "Not logged in") {
    setToken(undefined);
    setAuthorised(false);
  }
  ...
  if (navigationError?.message === "Not logged in") {
    setToken(undefined);
    setAuthorised(false);
  }
  ...
  if (pdfError?.message === "Not logged in") {
    setToken(undefined);
    setAuthorised(false);
  }
  ...
  if (propertyListError?.message === "Not logged in") {
    setToken(undefined);
    setAuthorised(false);
  }
  ...
  if (filterError?.message === "Not logged in") {
    setToken(undefined);
    setAuthorised(false);
  }

  var propertyIdList = propertyListData?.selectedPropertyList?.map(
    (property) => {
  ...
  if (
    suburbWCFormatted !== undefined &&
    suburbGauFormatted !== undefined &&
    suburbKZNFormatted !== undefined &&
    suburbOtherFormatted !== undefined
  ) {
  ...
  if (
    regionWCFormatted !== undefined &&
    regionGauFormatted !== undefined &&
    regionKZNFormatted !== undefined &&
    regionOtherFormatted !== undefined
  ) {
  ...
  if (
    regionWCFilterFormatted !== undefined &&
    regionGauFilterFormatted !== undefined &&
    regionKZNFilterFormatted !== undefined &&
    regionOtherFormatted !== undefined
  ) {
  ...
  if (landlordError?.message === "Not logged in") {
    setToken(undefined);
    setAuthorised(false);
  }
  ...
  if (propertyListsError?.message === "Not logged in") {
    setToken(undefined);
    setAuthorised(false);
  }
  ...
  React.useEffect(() => {
    if (
      navigationState.showSelectedPropertyPanel === true ||
      navigationState.showManageLandlordsPanel === true ||
      navigationState.showSavedListsPanel ===
        true /* || navigationState.showSelectedPropertyListPanel === true */
    ) {
    ...
    navigationState.showSelectedPropertyPanel,
    navigationState.showManageLandlordsPanel,
    navigationState.showSavedListsPanel,
    /* navigationState.showSelectedPropertyListPanel, */ scrollBarWidth,
  ]);
  ...
  return (
    ...
    >
      <Navigation
        selectedPropertyType={navigationState.selectedPropertyType}
        setSearch={setSearch}
        showSelectedPropertyListPanel={
          navigationState.showSelectedPropertyListPanel
        }
        showSavedListsPanel={navigationState.showSavedListsPanel}
      >
        {" "}
      </Navigation>
      <PropertyList propertyData={propertyData} search={search}></PropertyList>
      <NewProperyModal
        showNewPropertyModal={navigationState.showNewPropertyModal}
        distinctSuburbsOptions={distinctSuburbsOptions}
        distinctRegionsOptions={distinctRegionsOptions}
        landlordsOptions={landlordsOptions}
      ></NewProperyModal>
      ...
      ></SelectedPropertyListPanel>
      <PreviewPDFPanel
        showPreviewPDFPanel={navigationState.showPreviewPDFPanel}
        enquiryName={pdfVariables?.pdfVariables?.enquiryName!}
        agent={pdfVariables?.pdfVariables?.agent!}
        propertyIdList={propertyIdList!}
      ></PreviewPDFPanel>
      <ManageLandlordsPanel
        showManageLandlordsPanel={navigationState.showManageLandlordsPanel}
      ...
      ></SavedListsPanel>
      <FilterModal
        showFilterModal={navigationState.showFilterModal}
        distinctSuburbsFilterOptions={distinctSuburbsFilterOptions}
        distinctRegionFilterOptions={distinctRegionFilterOptions}
        landlordsFilterOptions={landlordsFilterOptions}
      ></FilterModal>
    </Stack>
  );
}
